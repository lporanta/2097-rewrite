...
const game_def_t def = {
	...
	.teams = {
		[TEAM_FEISAR] = {
			...
			.pilots = {0},
			.attributes = {
				[RACE_CLASS_VENOM]  = {.mass = 150, .thrust_max =  990, .resistance = 134, .turn_rate = TURN_ACCEL(180), .turn_rate_max = TURN_VEL(2560), .skid = 12},
				[RACE_CLASS_RAPIER] = {.mass = 150, .thrust_max = 1400, .resistance = 130, .turn_rate = TURN_ACCEL(180), .turn_rate_max = TURN_VEL(2560), .skid =  8},
		...
		[TEAM_AG_SYSTEMS] = {
			...
			.pilots = {1},
			.attributes = {
				[RACE_CLASS_VENOM]  = {.mass = 150, .thrust_max =  1100, .resistance = 140, .turn_rate = TURN_ACCEL(160), .turn_rate_max = TURN_VEL(2560), .skid = 12},
				[RACE_CLASS_RAPIER] = {.mass = 150, .thrust_max = 1400, .resistance = 140, .turn_rate = TURN_ACCEL(160), .turn_rate_max = TURN_VEL(2560), .skid = 10},
		...
		[TEAM_AURICOM] = {
			...
			.pilots = {2},
			.attributes = {
				[RACE_CLASS_VENOM]  = {.mass = 150, .thrust_max =  1100, .resistance = 134, .turn_rate = TURN_ACCEL(140), .turn_rate_max = TURN_VEL(1920), .skid = 20},
				[RACE_CLASS_RAPIER] = {.mass = 150, .thrust_max = 1600, .resistance = 140, .turn_rate = TURN_ACCEL(120), .turn_rate_max = TURN_VEL(1920), .skid = 14},
		...
		[TEAM_QIREX] = {
			...
			.pilots = {3},
			.attributes = {
				[RACE_CLASS_VENOM]  = {.mass = 150, .thrust_max =  1150, .resistance = 140, .turn_rate = TURN_ACCEL(120), .turn_rate_max = TURN_VEL(1920), .skid = 24},
				[RACE_CLASS_RAPIER] = {.mass = 150, .thrust_max = 1600, .resistance = 130, .turn_rate = TURN_ACCEL(140), .turn_rate_max = TURN_VEL(1920), .skid = 16},
		...
		[TEAM_PIRANHA] = {
			...
			.pilots = {4},
			.attributes = {
				[RACE_CLASS_VENOM]  = {.mass = 150, .thrust_max =  1200, .resistance = 134, .turn_rate = TURN_ACCEL(140), .turn_rate_max = TURN_VEL(1920), .skid = 8},
				[RACE_CLASS_RAPIER] = {.mass = 150, .thrust_max = 1900, .resistance = 130, .turn_rate = TURN_ACCEL(135), .turn_rate_max = TURN_VEL(1920), .skid = 8},
				[RACE_CLASS_PHANTOM] = {.mass = 150, .thrust_max = 2600, .resistance = 120, .turn_rate = TURN_ACCEL(135), .turn_rate_max = TURN_VEL(1920), .skid = 6},
			},
		},
	},
	...
	.circuts = {
		...
		[CIRCUT_GARE_D_EUROPA] = {
			...
			.is_bonus_circut = false,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout/track202/", .start_line_pos = 24, .behind_speed = 250, .spread_base = 10, .spread_factor = 4, .sky_y_offset = -1000},
				[RACE_CLASS_RAPIER] = {.path = "wipeout/track202/", .start_line_pos = 24, .behind_speed = 400, .spread_base = 10, .spread_factor = 4, .sky_y_offset = -1000},
				[RACE_CLASS_PHANTOM] = {.path = "wipeout/track202/", .start_line_pos = 24, .behind_speed = 650, .spread_base = 10, .spread_factor = 4, .sky_y_offset = -1000},
			}
		},
		[CIRCUT_ODESSA_KEYS] = {
			.name = "ODESSA KEYS",
	...
	.credits = {
		...
		"",
		"#SPECIAL THANKS TO",
			"ORIGINAL WIPEOUT DEVELOPERS",
			"DAVID ROSE",
			"M C  PLACE",
			"RED BULL FOR GETTING US",
...
save_t save = {
	...
	.buttons = {
		...
		[A_THRUST] = {INPUT_KEY_SPACE, INPUT_GAMEPAD_A},
