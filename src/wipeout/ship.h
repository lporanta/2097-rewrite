...
#define SHIP_FLYING_GRAVITY	180000.0 // 80000
#define SHIP_ON_TRACK_GRAVITY	50000.0 // 30000
#define SHIP_MIN_RESISTANCE	12 //20? 12
#define SHIP_MAX_RESISTANCE 	74
#define SHIP_VELOCITY_SHIFT	6
#define SHIP_TRACK_MAGNET	110 // 64
...
#define SHIP_THRUST_FALLOFF NTSC_VELOCITY(16) //8
