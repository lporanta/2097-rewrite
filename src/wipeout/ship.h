...
#define SHIP_FLYING_GRAVITY	100000.0 // 80000
#define SHIP_ON_TRACK_GRAVITY	30000.0 // 30000
#define SHIP_MIN_RESISTANCE	12 //20? 12
#define SHIP_MAX_RESISTANCE 	74
#define SHIP_VELOCITY_SHIFT	6
#define SHIP_TRACK_MAGNET	150 // 64
...
#define SHIP_THRUST_RATE    NTSC_VELOCITY(32) //16
#define SHIP_THRUST_FALLOFF NTSC_VELOCITY(32) //8
#define SHIP_BRAKE_RATE     NTSC_VELOCITY(16) //32
